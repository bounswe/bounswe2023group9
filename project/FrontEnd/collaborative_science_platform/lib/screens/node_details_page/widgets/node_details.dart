          ...
          children: [
            ...
            if (currentIndex == 2)
              Padding(
                ...
                child: References(
                    references: [SmallNode.getLoremIpsum(1), SmallNode.getLoremIpsum(1), SmallNode.getLoremIpsum(1)]),
              ),
            if (currentIndex == 3)
              //citations
              Padding(
            ...
            if (currentIndex == 5)
              ...
              Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
                  child: Contributors(contributors: widget.node.contributors, controller: widget.controller)),
          ],
        ),
      ),
    );
